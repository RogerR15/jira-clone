...
export const KanbanColumnHeader = ({ board, taskCount }: KanbanColumnHeaderProps) => {
    ...
    return (
        <div className="flex items-center py-1.5 px-2 justify-between">
            ...
            <Button onClick={open} variant="ghost" size="icon" className="size-5 cursor-pointer">
                <PlusIcon className="size-4 text-neutral-500 cursor-pointer" />
            </Button>
        </div>
    );
}   